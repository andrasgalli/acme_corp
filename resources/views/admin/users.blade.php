                ...
                @if(count($users) > 0)
                    <table class="table-auto w-full">
                        ...
                        <tr>
                            ...
                            <th class="text-white text-left p-2">Email</th>
                            <th class="text-white text-left p-2">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($users as $user)
                            <tr>
                                <td class="text-white text-left p-2">{{ $user->name }}</td>
                                <td class="text-white text-left p-2">{{ $user->email }}</td>
                                <td class="text-white text-left p-2"></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
